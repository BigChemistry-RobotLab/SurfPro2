...
SOURCE_FILE = "source_data/yoshimura2004_table_2.csv"
PROCESSED_FILE = "processed_data/yoshimura2004.csv"

df = pd.read_csv(SOURCE_FILE)

df["CMC"] = df["cmc (mmol dm−3)"] / 1000
df["Gamma_max"] = df["106Γcmc (mol m−2)"] / 10**6

replace_columns = {
    "Surfactant": "identifier",
    "γcmc (mN m−1)": "AW_ST_CMC",
    "Acmc (nm2 molecule−1 )": "Area_min",
}
