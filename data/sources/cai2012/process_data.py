...
SOURCE_FILE = "source_data/cai2012_table_2.csv"
PROCESSED_FILE = "processed_data/cai2012.csv"

df = pd.read_csv(SOURCE_FILE)

replace_columns = {
    "Surfactant": "identifier",
    "CMC no salt (mol/L)": "CMC",
    "Amin No salt (nm2)": "Area_min",
    "γCMC no salt (mN/m)": "AW_ST_CMC",
    "pC20 no salt": "pC20",
}
