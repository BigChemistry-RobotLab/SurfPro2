...
SOURCE_FILE = "source_data/zhuang2013_table_2.csv"
PROCESSED_FILE = "processed_data/zhuang2013.csv"

df = pd.read_csv(SOURCE_FILE)

df["CMC"] = df["cmc (mM)"]/1000
df["Gamma_max"] = df["106 Γmax n=3 (mol/m2)"]/10**6

replace_columns = {
    "Surfactant": "identifier",
    "γcmc (mN/m)": "AW_ST_CMC",
    "Amin n=3 (nm2)": "Area_min"
}
