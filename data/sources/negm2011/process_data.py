...
SOURCE_FILE = "source_data/negm2011_table_2.csv"
PROCESSED_FILE = "processed_data/negm2011.csv"
...
drop_columns = ["CMC, mmole l-1", "γIT, mN m-1"]

df["CMC"] = df["CMC, mmole l-1"] / 1000
